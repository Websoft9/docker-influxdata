...
本项目是由 [Websoft9](https://www.websoft9.com) 研发的 **云原生程序** ，大大简化 InfluxDB 复杂的安装及配置。

## 系统要求

安装本项目，确保符合如下的条件（[详细参考](https://docs.influxdata.com/influxdb/latest/install/?t=Docker)）：
...
启动应用后，本地浏览器访问 URL: *`http://服务器公网IP:8086`* 进入应用。  
...
| 名称 | 端口号 | 用途 |  必要性 |
| --- | --- | --- | --- |
| influxdb | 8086 | 浏览器访问 InfluxDB | Y |
| chronograf | 9090 | 浏览器访问 Chronograf | Y |
## 文档

[InfluxDB 管理员手册](https://support.websoft9.com/docs/influxdb)

## 企业级支持

如果需要企业级支持，请订阅我们提供的 [InfluxDB 企业级支持版](https://apps.websoft9.com/influxdb) 
